...
% Last Modified by GUIDE v2.5 16-Jun-2018 00:08:56
...
% 显示图片
cData=imread('numerical analysis.jpg');
image(cData);
 axis off;%关掉网格
...
set(handles.edit1,'string','4 9');
          set(handles.edit2,'string','2 3');
          set(handles.edit3,'string','7');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
czf_set1 = get(handles.radiobutton1,'value');
czf_set2 = get(handles.radiobutton2,'value');
czf_set3 = get(handles.radiobutton3,'value');
czf_set4 = get(handles.radiobutton4,'value');
czf_uX= get(handles.edit1,'string');%已知的X
czf_uY= get(handles.edit2,'string');%已知的Y
czf_unknownX= get(handles.edit3,'string');%要求的x
czf_uy1= get(handles.edit4,'string');%要求的y'

czf_X = str2num(czf_uX);
czf_Y = str2num(czf_uY);
czf_rX = str2num(czf_unknownX);
czf_ry1 = str2num(czf_uy1);
interpolation_simu;
ry_string = num2str(czf_rY);
set(handles.text2,'string',ry_string);
...
switch tString
    ...
    case 'radiobutton2'
        map=imread('ndczf.jpg');
          ...
          set(handles.text8,'visible','off');
    case 'radiobutton3'
          set(handles.edit1,'string','0.4 0.5 0.7 0.8');
          set(handles.edit2,'string','-0.916291 -0.693147 -0.356675 -0.223144');
          set(handles.edit3,'string','0.6');
          set(handles.edit4,'string','2.50 2.00 1.43 1.25');
